---@diagnostic disable: need-check-nil, unbalanced-assignments, undefined-global, duplicate-set-field, cast-local-type, param-type-mismatch, missing-local-export-doc, redundant-parameter, undefined-field, inject-field
--[[
        luaunit.lua
